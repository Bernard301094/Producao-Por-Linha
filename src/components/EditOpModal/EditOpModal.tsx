        ...
        {editingOp && (
          <form onSubmit={handleSubmitEdit(onEditOp)} className="space-y-6">
            ...
            <div className="relative space-y-2" ref={editOpRef}>
              ...
              {showEditProductSuggestions && (
                <div className="absolute bottom-full mb-2 z-[100] w-full bg-white dark:bg-zinc-950 border border-zinc-200 dark:border-zinc-800 rounded-2xl shadow-xl max-h-60 overflow-y-auto p-2 ring-1 ring-zinc-900/5">
                  {!isTypingEditProduct && (
