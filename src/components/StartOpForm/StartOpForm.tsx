        ...
        <CardHeader className="bg-slate-900 border-b border-slate-800 p-5 sm:p-7 space-y-0 shrink-0 relative overflow-hidden shadow-inner">
          ...
          <div className="flex items-center justify-between gap-4 relative z-10">
            ...
            <div className="flex flex-col items-end shrink-0">
              ...
              <span className="text-base font-black text-slate-100 uppercase tracking-tighter bg-card px-3 py-1 rounded-xl border border-white/5 shadow-sm leading-none">
            ...
            <Dialog open={showConfirmStart} onOpenChange={setShowConfirmStart}>
              ...
              <DialogContent className="w-[calc(100%-2rem)] max-w-[440px] max-h-[92dvh] overflow-y-auto rounded-b-none rounded-t-[2rem] sm:rounded-[2rem] p-6 sm:p-8 shadow-2xl border-0 ring-1 ring-border gap-0 top-auto bottom-0 sm:top-1/2 sm:bottom-auto translate-y-0 sm:-translate-y-1/2 pb-[max(1.5rem,env(safe-area-inset-bottom))] sm:pb-8">
                <DialogHeader className="text-center space-y-3 mb-8">
                  <div className="w-16 h-16 bg-zinc-100 dark:bg-zinc-800 text-foreground rounded-2xl flex items-center justify-center mx-auto mb-2 border border-border shadow-sm">
                    <Play className="w-8 h-8 fill-current ml-1" />
                  </div>
                  <DialogTitle className="text-2xl sm:text-3xl font-black text-foreground tracking-tight">Iniciar OP?</DialogTitle>
                  <DialogDescription className="text-muted-foreground font-medium text-base leading-relaxed mx-auto max-w-[300px]">
                ...
                <div className="flex flex-col items-center justify-center min-w-0 h-20 bg-muted border-2 border-border rounded-[1.5rem] shadow-inner p-3 text-center mb-8">
                ...
                <div className="flex flex-col gap-3">
                  ...
                  <Button type="button" variant="ghost" onClick={() => setShowConfirmStart(false)} className="w-full h-14 rounded-2xl text-base font-bold text-muted-foreground hover:bg-zinc-100 dark:hover:bg-zinc-800 dark:bg-zinc-800 dark:hover:bg-zinc-800 dark:bg-zinc-800 hover:text-foreground focus-visible:ring-2 focus-visible:ring-zinc-900/20 transition-all">
                    Revisar Dados
                  </Button>
                </div>
              </DialogContent>
